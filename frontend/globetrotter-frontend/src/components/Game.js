...
const Game = ({ username }) => {
    ...
    useEffect(() => {
        ...
        if (challenger && score) {
            ...
            axios.get(`http://localhost:5000/api/user/set-challenged-highscore`, {
    ...
    const updateScore = async (newScore) => {
        try {
            await axios.post(`http://localhost:5000/api/user/${username}/update-score`, {
                score: newScore,
            });
    ...
    const fetchHighScores = async () => {
        try {
            const userHighScoreResponse = await axios.get(`http://localhost:5000/api/user/${username}/highscore`);
            const globalHighScoreResponse = await axios.get('http://localhost:5000/api/user/globalhighscore');
